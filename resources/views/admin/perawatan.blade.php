...
@section('content')
    <div class="page-inner">
        <div class="page-header">
            <h4 class="page-title"><i class="fas fa-users pr-2"></i>Perawatan</h4>
        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive text-nowrap">
                            <table id="dataPerawatan" class="table table-borderless">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Nama</th>
                ...
                <form id="upsertDataForm">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <small id="jenis-error" class="text-danger"></small>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '#simpanData', function(e) {
                ...
                let url = id ? `/naive-bayes/perawatan/update/${id}` : '/naive-bayes/perawatan/create';
            ...
            $(document).on('click', '.edit-btn', function() {
                let id = $(this).data('id');
                $.ajax({
                    url: `/naive-bayes/perawatan/get/${id}`,
                    method: "GET",
                    dataType: "json",
                    success: function(response) {
                        console.log(response);
            ...
            $(document).on('click', '.delete-confirm', function() {
                ...
                function deleteData() {
                    $.ajax({
                        type: 'DELETE',
                        url: `/naive-bayes/perawatan/delete/${id}`,
                        dataType: 'json',
                        success: function(response) {
                            console.log(response);
